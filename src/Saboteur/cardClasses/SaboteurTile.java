...
public class SaboteurTile extends SaboteurCard {
    ...
    public static boolean canBeFlipped(String idx) {
        String[] flippable = { "2", "2_flip", "3", "3_flip", "4", "4_flip", "5", "5_flip", "6", "6_flip", "7", "7_flip",
                "9", "9_flip", "11", "11_flip", "12", "12_flip", "14", "14_flip" };
        // String[] unFlippable =
        // {"0","1","8","10","13","15","entrance","hidden1","hidden2","nugget"};
